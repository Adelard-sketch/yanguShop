...
export default function Register() {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      // If backend suggests redirect and provides verification state, follow it
      if (res && res.redirect) {
        navigate(res.redirect, { state: { message: res.message, isVerified: res.isVerified } });
      } else {
        navigate('/login', { state: { message: res?.message, isVerified: res?.isVerified } });
      }
    } catch (err) { 
